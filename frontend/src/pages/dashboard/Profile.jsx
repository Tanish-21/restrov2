    ...
    return (
        <div className="bg-black text-white font-body-md min-h-screen pb-32">
            ...
            <main className="pt-24 px-6 max-w-2xl mx-auto flex flex-col items-center">
                ...
                <h2 className="text-2xl font-headline-lg mb-1">Alex Nocturne</h2>
                ...
                <div className="w-full space-y-4">
                    ...
                    <button onClick={() => navigate('/')} className="w-full mt-8 p-4 rounded-xl bg-white/5 border border-red-500/30 text-red-500 font-label-md hover:bg-red-500/10 transition-all">
                        Sign Out
                    </button>
                </div>
            </main>
